export const errorsDB = [
  ...
  {
    code: 101,
    desc: 'No API Key was specified or an invalid API Key was specified.',
  },
  { code: 103, desc: 'The requested API endpoint does not exist.' },
  {
    code: 104,
    desc: 'The maximum allowed API amount of monthly API requests has been reached.',
  },
  {
    code: 105,
    desc: 'The current subscription plan does not support this API endpoint.',
  },
  { code: 106, desc: 'The current request did not return any results.' },
  {
    code: 102,
    desc: 'The account this API request is coming from is inactive.',
  },
